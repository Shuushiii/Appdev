...
<head>
    ...
    <title>{{ $setting->title_in }} | {{$title->title_in}} - {{ $post->title_in }} </title>
    <?php }else{ ?>
    <title>{{ $setting->title_in }} | {{$title->title_in}} </title>ne
    <?php } ?>
    @elseif ( Session::get('langEN') != NULL || Session::get('langIN') == NULL )
    <?php if (isset($title_sub)){ ?>
    <title>{{ $setting->title_en }} | {{$title->title_en}} - {{ $post->title_en }} </title>
    <?php }else{ ?>
    <title>{{ $setting->title_en }} | {{$title->title_en}} </title>
    <?php } ?>
    @endif
...
<body>
	...
	<header class="head-mobile">
		<nav class="top">
			<div class="flex-box wrap">
				<a href="http://reg.reandabernardi.com/login">@lang('main.services_list_login')</a>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top btm-nav">
			<div class="container">
              ...
              <div class="" style="margin-bottom: 6px">
                <select class="sel-lang" style="width: 100px; background-color: DodgerBlue; color: white; border-color: DodgerBlue; ">
                  <option value="en" 
			...
			<div class="container">
				<div class="bottom-menus">
					<div class="flex-box">
						...
						<ul class="root-menu">
							<li>
								<a href="{{ route('compro.servLists') }}">@lang('main.menu_service')</a>
								<ul class="submenu">
								<!-- @foreach ($servs as $serv)
									<li><a href="{{ route('compro.servListId',['id'=>$serv->service_id]) }}">{{$serv->name}}</a></li>
								@endforeach -->
                <li><a href="{{ route('compro.servListId',['id'=>2]) }}">@lang('main.menu_service_list1')</a></li>
                <li><a href="{{ route('compro.servListId',['id'=>3]) }}">@lang('main.menu_service_list2')</a></li>
                <li><a href="{{ route('compro.servListId',['id'=>4]) }}">@lang('main.menu_service_list3')</a></li>
                <li><a href="{{ route('compro.servListId',['id'=>5]) }}">@lang('main.menu_service_list4')</a></li>
                <li><a href="{{ route('compro.servListId',['id'=>6]) }}">@lang('main.menu_service_list5')</a></li>
                <li><a href="{{ route('compro.servListId',['id'=>7]) }}">@lang('main.menu_service_list6')</a></li>
                <li><a href="{{ route('compro.servListId',['id'=>8]) }}">@lang('main.menu_service_list7')</a></li>
                <li><a href="{{ route('compro.servListId',['id'=>9]) }}">@lang('main.menu_service_list8')</a></li>
                <li><a href="{{ route('compro.servListId',['id'=>10]) }}">@lang('main.menu_service_list9')</a></li>
                <li><a href="{{ route('compro.servListId',['id'=>11]) }}">@lang('main.menu_service_list10')</a></li>
    ...
    <p class="enclose problem">
        <a href="https://wa.me/6282111766700"><img style="height: 100px" style="width: 100px"  src="{{asset('assets/compro/assets/frontend_assets/images/WA.png')}}" alt="WA"></a>
    </p>
	<footer>
		<div class="container">
			<div class="row">
